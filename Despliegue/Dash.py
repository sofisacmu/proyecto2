...
df = pd.read_csv(
    "https://www.dropbox.com/scl/fi/6q2synntpk2v5ng7w47rg/Datos2011Limipios.csv?rlkey=m1i9eo8sur1azd13swvqy1teh&st=z00mielw&dl=1"
)
...
app.layout = dbc.Container(
    [
        html.H2(
            "Simulador de Desempeño en Inglés en las Pruebas Saber 11",
            className="text-center mt-4",
        ),
        html.P(
            "Bienvenido, si eres estudiante, con este simulador podrás estimar tu perfil de desempeño en la prueba de inglés del examen Saber 11 según tus características",
        ...
        html.Hr(),
        html.H4(
            "Características de estudiantes con mejores resultados", className="mt-4"
        ),
        dbc.Row(
            [
                dbc.Col(
                    dcc.Graph(
                        figure=px.bar(
                            df[df["resultado"] == "exitoso"]["fami_estratovivienda"]
                            .value_counts()
                            .reset_index(),
            ...
            [
                dbc.Col(
                    [
                        ...
                        dcc.Dropdown(
                            id="input-cole_depto_ubicacion",
                            options=[
                                {"label": d, "value": d} for d in sorted(departamentos)
                            ],
                ...
                dbc.Col(
                    [
                        ...
                        dcc.Dropdown(
                            ...
                            options=[
                                {"label": e, "value": e} for e in sorted(ed_madre)
                            ],
                ...
                dbc.Col(
                    [
                        ...
                        dcc.Dropdown(
                            ...
                            options=[
                                {"label": e, "value": e} for e in sorted(ed_padre)
                            ],
                ...
                dbc.Col(
                    [
                        ...
                        dcc.Dropdown(
                            ...
                            options=[
                                {"label": e, "value": e} for e in sorted(estratos)
                            ],
        ...
        dbc.Button(
            "Evaluar mi perfil", id="btn-evaluar", color="primary", className="mb-3"
        ),
        html.Div(
...
def actualizar_municipios(depto):
    if not depto:
        return [], True
    municipios = (
        df[df["cole_depto_ubicacion"] == depto]["cole_mcpio_ubicacion"]
        .dropna()
        .unique()
    )
...
def evaluar_perfil(n_clicks, *inputs):
    ...
    try:
        ...
        return dbc.Alert(
            f"Tu perfil fue clasificado como: {resultado} con una probabilidad del {porcentaje}% en la prueba de inglés",
            color=color,
        )
